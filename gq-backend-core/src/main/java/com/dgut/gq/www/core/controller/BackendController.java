...
import com.dgut.gq.www.core.model.vo.CurriculumVitaeVo;
...
public class BackendController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(value = "状态 0-抢到票的人  1-签到和签退都完成的人(观看了讲座)",name = "status",required = true),
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(value = "讲座id",name = "id",required = true),
            @ApiImplicitParam(value = "状态 0-抢到票的  1-观看讲座的",name = "status",required = true),
    })
    @ApiResponses({
            @ApiResponse(code = 200, message = "查询成功", response = UserVo.class)
    }
     ...
     */
    @ApiResponse(
            code = 200, message = "成功",response = CurriculumVitaeVo.class)
    ...
    @PreAuthorize("hasAuthority('admin')")
    @ApiImplicitParams({
            @ApiImplicitParam(value = "学号",name = "studentId",required = true),
            @ApiImplicitParam(value = "票号",name = "ticketId",required = true),
    })
    ...
    @PreAuthorize("hasAuthority('admin')")
    @ApiImplicitParams({
            @ApiImplicitParam(value = "起始票号",name = "startId",required = true),
            @ApiImplicitParam(value = "结束票号",name = "endId",required = true),
    })
